...
const Card: React.FC<CardProps> = ({
  ...
  const cardBaseStyle =
    "absolute inset-0 rounded-2xl shadow-lg flex items-center justify-center p-2 text-center backface-hidden border border-black overflow-hidden";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`${cardBaseStyle} bg-gradient-to-br from-black via-gray-900 to-black ${
            isFlipped ? "z-0" : "z-10"
        ...
        <div
          className={`${cardBaseStyle} bg-black transform rotate-y-180 ${
            isMatched ? "opacity-70 border-green-500" : ""
          }`}
        >
          {imageSrc ? (
