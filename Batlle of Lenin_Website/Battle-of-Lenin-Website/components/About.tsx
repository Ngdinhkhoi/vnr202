...
const About: React.FC = () => {
  return (
    <section
      id="about"
      className="relative overflow-hidden py-24 bg-gradient-to-br from-[#0c101b] via-[#080b12] to-[#020205] text-gray-200"
    >
      {/* Background Effects */}
      ...
      <div className="container relative mx-auto px-6">
        ...
        <div className="text-center">
          <span className="text-xs font-semibold uppercase tracking-[0.5em] text-brand-gold/70">
            Guidebook
          </span>
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base text-gray-300 md:text-lg">
            Khám phá câu chuyện và hình ảnh trực quan về hai chế độ chơi đầy hấp
            dẫn của Đại Đồng.
          </p>
        </div>
        ...
        <div className="relative mt-16 mb-24 grid items-stretch gap-8 lg:grid-cols-2">
          ...
          <article className="h-full flex flex-col justify-center rounded-[2.5rem] border border-white/10 bg-white/5 p-10 backdrop-blur-xl shadow-2xl transition-all hover:border-white/20 group">
            <h3 className="text-3xl font-bold text-amber-500 mb-6 group-hover:scale-105 transition-transform origin-left">
              Câu chuyện hình thành
            </h3>
            <div className="space-y-6 text-base md:text-lg leading-relaxed text-gray-300">
              <p>
                <strong className="text-white">Đại Đồng</strong> ra đời từ mong
                muốn tạo nên một sân chơi nơi chiến lược, tư duy phản biện và
                tinh thần đồng đội được bồi đắp qua từng ván đấu.
              </p>
              <p>
                Mỗi câu hỏi là một cánh cửa mở ra chiều sâu tri thức, giúp người
                chơi khám phá bản thân và kết nối cộng đồng yêu chủ nghĩa
                Mác-Lênin bằng trải nghiệm tranh biện sống động.
              </p>
            </div>
          </article>
          ...
          <div className="grid gap-6 grid-rows-2 h-full">
            ...
            <article className="flex flex-col justify-center rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 backdrop-blur-xl shadow-xl transition-all hover:bg-white/[0.05]">
              ...
              <p className="text-base text-gray-300 leading-relaxed">
                Truyền cảm hứng nghiên cứu thông qua trải nghiệm game độc đáo,
                thắp lửa đam mê học hỏi.
              </p>
            </article>
          </div>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2 items-stretch">
          ...
          {/* <div className="relative w-full aspect-video rounded-[28px] overflow-hidden">
              ...
              <div className="relative mt-6 space-y-3 text-sm text-gray-200/85 flex-grow">
                <p className="font-semibold tracking-[0.3em] uppercase text-brand-gold/80">
                  Luật chơi nhanh
                </p>
                <p>
                  Lật thẻ, chờ câu hỏi hiện ra và phản xạ nhanh trong 20s để ghi
                  điểm tối đa.
                </p>
                <p className="text-xs opacity-70">
                  Thử thách kiến thức và tốc độ.
                </p>
              </div>
            </div>
          </div>  */}
