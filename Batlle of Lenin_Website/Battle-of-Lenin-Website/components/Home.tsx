...
const Home: React.FC<HomeProps> = ({ navigate }) => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen bg-[#0a0a0a] text-white overflow-hidden font-sans selection:bg-rose-500/30"
    >
      {/* --- BACKGROUND ANIMATION --- */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-blue-900/20 rounded-full blur-[120px] animate-pulse-slow"></div>
        <div
          className="absolute bottom-[-20%] right-[-10%] w-[60%] h-[60%] bg-rose-900/20 rounded-full blur-[150px] animate-pulse-slow"
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center w-full">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl leading-relaxed border-l-4 border-rose-500/50 pl-6">
              Chào mừng bạn đến với <strong>Đại Đồng</strong>. Không chỉ là học
              tập, đây là hành trình
              <span className="text-white font-medium"> khai phóng tư duy</span>
              . Kết hợp lý luận sâu sắc với công nghệ gamification, chúng tôi
              biến những khái niệm trừu tượng thành trải nghiệm sống động.
            </p>
            ...
            <div className="relative z-20 bg-white/5 backdrop-blur-2xl border border-white/10 p-8 rounded-[2.5rem] shadow-2xl">
              ...
              <div className="flex flex-col gap-6">
                ...
                <blockquote className="text-xl font-serif italic text-gray-200 leading-relaxed">
                  "Lý luận mà không có thực tiễn là lý luận suông. Thực tiễn mà
