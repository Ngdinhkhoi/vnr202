...
const quizResources = [
  {
    title: "Giáo trình VNR202",
    url: "https://drive.google.com/file/d/1x8bnEVZv4kESG44IH0iRDAq-FbxTggGX/view?usp=drive_link",
  },
];

const ResourceCard: React.FC<{ title: string; url: string }> = ({
  title,
  url,
}) => (
  <a
  ...
  >
    ...
    <div className="relative">
      <h4 className="text-lg font-semibold text-white transition-colors duration-300 group-hover:text-brand-gold">
        {title}
      </h4>
...
const Resources: React.FC = () => {
  return (
    <section
      id="resources"
      className="relative overflow-hidden bg-[#060810] py-24 text-gray-100"
    >
      ...
      <div className="container relative mx-auto px-6">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-4xl md:text-5xl font-extrabold text-white">
            Nguồn Dữ Liệu &amp;{" "}
            <span className="text-brand-gold">Tài Nguyên</span>
          </h2>
          <p className="mx-auto mt-4 max-w-3xl text-base text-gray-300">
            Kho tư liệu được tuyển chọn để nuôi dưỡng tinh thần triết học và
            chiến lược của Đại Đồng.
          </p>
        </div>

        <div className="relative mx-auto mt-16 max-w-4xl">
          <div>
            <h3 className="text-center text-2xl font-semibold text-brand-gold uppercase tracking-[0.3em]">
              Dữ liệu câu hỏi Quiz
            </h3>
            <p className="mx-auto mt-6 max-w-3xl text-center text-sm text-gray-300">
              Tất cả dữ liệu câu hỏi trong game "Đại Đồng" được tham khảo từ các
              bộ đề công khai, được tuyển lọc và phân loại kỹ lưỡng nhằm tạo ra
              trải nghiệm đa chiều và uyên thâm.
            </p>
